/* Adapted from Card-Forge/forge test adapter. GPL-3.0-or-later. Changes: package and base class. */
package table;
 ...
 */
public class BaseWebGui extends AbstractGuiGame {
    ...
    public void showErrorDialog(String message, String title) {
        System.err.println("[BaseWebGui] " + title + ": " + message);
    }
